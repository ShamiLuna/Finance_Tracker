...
class CustomlisttileView extends GetView<CustomlisttileController> {
  final HomeController controllerr = Get.put(HomeController());


   CustomlisttileView({super.key});
  @override
...
//     //   final decodedBytes = base64Decode(fileBase64);
//     //   fileWidget = Image.memory(decodedBytes, height: 50, width: 50, fit: BoxFit.cover);
//     // }
//     Color containerColor = Colors.grey;
//     IconData iconData = Icons.shopping_bag; // Default icon
//     switch (title.toLowerCase()) {
//       case 'food':
//         iconData = Icons.restaurant;
//         containerColor = Colors.yellow;
