...
// import '../../../ssstorage/secured_storage_service.dart';
                            ...
                            Padding(
                              ...
                              child: Container(
                                ...
                                child: ListTile(
                                  ...
                                  title:  Padding(
                                    padding: const EdgeInsets.all(8.0),
                                    child: Text("Export Data".tr, style: TextStyle(fontFamily: 'Roboto',fontSize: MediaQuery.of(context).size.width * 0.05,fontWeight: FontWeight.bold,color: Theme.of(context).primaryColorDark,)),
                                  ),
                                  trailing:  Icon(Icons.arrow_forward_ios,color: Theme.of(context).cardColor,),
                                ),
                              ),
                                    ...
                                    return AlertDialog(
                                      ...
                                      actions: <Widget>[
                                        ...
                                        TextButton(
                                          onPressed: () async {
                                            Navigator.of(context).pop(); // Close the dialog
                                            await _customSecureStorageService.logout();
