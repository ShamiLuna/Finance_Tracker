                            ...
                            child: SizedBox(
                              ...
                              child: SingleChildScrollView(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children:
                                      displayedCategories1.map((category) {
                                    Color color = controller
                                            .categoryColors[category] ??
                                        controller.getColorFromString(
                                            category); // Normalize to lowercase
...
//   final String type;
//
//   DataChart({required this.data, required this.type});
//
//   @override
//   Widget build(BuildContext context) {
//     List<FlSpot> spots = [];
...
//
//     return Container(
//       height: keys.length * 120.0, // Adjust this value as needed
//       width: keys.length * 150.0, // Adjust this value as needed
//       child: LineChart(
//         LineChartData(
//           gridData: FlGridData(
//             show: true,
...
//                   return Padding(
//                     padding: const EdgeInsets.all(8.0),
//                     // child: Text(value.toString(), style: TextStyle(color: Colors.black, fontSize: 12)),
//                   );
//                 },
//               ),
//             ),
...
//                     return Padding(
//                       padding: const EdgeInsets.all(8.0),
//                       child: Text(keys[value.toInt()], style: TextStyle(color: Colors.black, fontSize: 12)),
//                     );
//                   }
//                   return Text('');
//                 },
...
// left right scrollable indicator
